...
})({"iaMnX":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "4a236f9275d0a351";
module.bundle.HMR_BUNDLE_ID = "c3580bd3d648119d";
"use strict";
...
},{}],"jIiYx":[function(require,module,exports) {
class Skills {
    constructor($element){
    ...
    onJumpTargetIntersection(entries, observer) {
        ...
        if (visible.length) this.renderJumpAnchors(visible[0].target);
    }
    renderJumpAnchors($jumpTarget) {
        for (const $jumpAnchor2 of this.$jumpAnchors)$jumpAnchor2.classList.remove('--active');
        const $jumpAnchor1 = this.$jumpAnchors.find(($jumpAnchor)=>{
            const id = $jumpAnchor.href.split('#')[1];
            return id == `${$jumpTarget.id}`;
        });
        $jumpAnchor1.classList.add('--active');
...
},{}]},["iaMnX","jIiYx"], "jIiYx", "parcelRequirec3d0")

//# sourceMappingURL=index.d648119d.js.map
